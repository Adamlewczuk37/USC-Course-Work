...
def get_inbox(recipient: str) -> None:
    """
    Finds the inbox of the receipient's mail inbox by sending the server a GET request
    for the /mail/inbox endpoint of the recipient.
...
def get_sent(sender: str) -> None:
    """
    Finds the sent messages of the sender by sending the server a GET request for the 
    /mail/sent endpoint of the sender.
...
def get_mail(mail_id: str) -> None:
    """
    Gets a specific piece of mail by sending the server a GET request for the
    /mail/{mail_id} endpoint where the brackets specify the specific ID for that
    piece of mail.
    
    Args:
        mail_id (str): The id of the piece of mail
...
def delete_mail(mail_id: str) -> None:
    """
    Deletes a specific piece of mail by sending the server a DELETE request for the
    /mail/{mail_id} endpoint where the brackets specify the specific ID for that
    piece of mail.
    
    Args:
        mail_id (str): The id of the spiece of mail
