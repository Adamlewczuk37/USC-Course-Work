...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("lewczuk/ipinfo")
    
    client.message_callback_add("lewczuk/ipinfo", on_message_from_ipinfo)


    client.subscribe("lewczuk/date")
    
    client.message_callback_add("lewczuk/date", on_message_from_ipinfo)
    

    client.subscribe("lewczuk/time")

    client.message_callback_add("lewczuk/time", on_message_from_ipinfo)
